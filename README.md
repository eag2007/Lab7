...
Клиент-серверное приложение для управления коллекцией маршрутов (`Route`). Сервер поддерживает многопоточную обработку запросов, хранение данных в PostgreSQL и авторизацию пользователей.
